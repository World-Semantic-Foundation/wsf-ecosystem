...
**Description:** The three Iansiti and Levien metrics (Productivity, Robustness, Niche Creation) can be further decomposed indefinitely (Productivity → transaction velocity, conversion rate, throughput, …).
