...
| **Productivity** | Tier 3 | `wsf:Measure` | Iansiti–Levien metric. |
| **Robustness** | Tier 3 | `wsf:Measure` | Iansiti–Levien metric. |
| **Niche Creation** | Tier 3 | `wsf:Measure` | Iansiti–Levien metric. |
