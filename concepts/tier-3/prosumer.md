...
- **Related to:** `wsf:Value Co-creation`, `wsf:Incentive Alignment`, `wsf:Digital Footprint`

---

*Prosumer is a Tier 3 specialisation of Actor (hybrid class demonstrating non-mutual exclusion). Status: Baseline.*
