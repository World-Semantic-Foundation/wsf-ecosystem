...
> **The emergent state resulting from high switching costs combined with strong network effects.**

```yaml
semantic_id: wsf:Lock-In
...
- **Related to:** `wsf:Switching Costs`, `wsf:Network Effects`, `wsf:Ecosystem Lifecycle (Leadership)`

---

*Lock-In is a Tier 3 specialisation of State. Status: Baseline.*
