# Dominator (Keystone Competitor)

> **An entity with high market share that extracts disproportionate value, harming long-term ecosystem health.**

```yaml
semantic_id: wsf:Dominator
preferred_name: Dominator
...
- **Specialises:** `wsf:Orchestrator`
- **Related to:** `wsf:Ecosystem Health`, `wsf:Value Slippage` (inverse concern), `wsf:Governance`

---

*Dominator is a Tier 3 specialisation of Orchestrator (degraded variant). Status: Baseline.*
